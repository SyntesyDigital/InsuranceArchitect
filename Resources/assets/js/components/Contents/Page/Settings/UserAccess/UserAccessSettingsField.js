...
*/
class UserAccessSettingsField extends Component {
  ...
  constructor(props) {
    ...
    this.visibilityOptions = [
      //by default can be only invisible. Because hierarchy between pages.
      {
          name : 'Invisible',
  ...
  */
  ...
  processProps(nextProps){
    ...
    if(nextProps.field != null && nextProps.field[nextProps.source] != null &&
      ...
      console.log("UserAccessSettingsField :: componentWillRecieveProps",nextProps.field[nextProps.source][nextProps.name]);
    }
  ...
  processCondition(condition,index) {
    ...
    console.log("processCondition :: ",conditionalAction);
  ...
  openModal(e) {
    ...
    console.log("processCondition :: openModal (conditions)",value);
  ...
  getDefaultConditionValue() {
    return {
      ...
      type : CONDITION_FIELD_TYPE_PERMISSION,
      name : CONDITION_FIELD_TYPE_PERMISSION,
...
export default UserAccessSettingsField;
