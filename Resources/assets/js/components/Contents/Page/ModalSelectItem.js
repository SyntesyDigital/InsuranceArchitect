...
class ModalSelectItem extends Component {
  ...
  renderFields() {
    ...
    var nonAllowed = [
        ...
        FIELDS["URL"].type,
        //FIELDS["FILE"].type,
        FIELDS["TRANSLATED_FILE"].type,
        //FIELDS["VIDEO"].type,
        FIELDS["LOCALIZATION"].type,
        FIELDS["DATE"].type,
        FIELDS["LINK"].type
    ];
          ...
          widgets.push(
            <div className="col-xs-4" key={key}>
              <a href="" onClick={this.addItem.bind(this,WIDGETS[key])}>
                <div className="grid-item with-image" style={{backgroundImage:'url('+ASSETS+'modules/extranet/img/widgets/'+WIDGETS[key]['label'].toLowerCase()+'.jpg)'}}>
