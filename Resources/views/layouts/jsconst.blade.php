<script>
  ...
  const ROW_SETTINGS = ['htmlId','htmlClass','hasContainer','textAlign','hideBorders', 'boxClass','conditionalVisibility', 'displayInline', 'displayLabel'];
  ...
  const PAGE_SETTINGS = ['htmlClass','pageType','accessByLink'];
